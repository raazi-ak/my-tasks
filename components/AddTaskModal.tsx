...
export default function AddTaskModal({ visible, onClose, onAdd, categories }: AddTaskModalProps) {
  ...
  const formatTime = (time: Date) => {
    // Detect system time format by creating a test time and checking if it contains AM/PM
  ...
  const getComplementaryColor = (color: string) => {
    // Simple complementary color logic - return white for dark colors, dark for light colors
    const colorMap: { [key: string]: string } = {
      '#2563EB': '#ffffff', // Work - blue
      '#059669': '#ffffff', // Personal - green  
      '#DC2626': '#ffffff', // Health - red
      '#7C3AED': '#ffffff', // Learning - purple
      '#EA580C': '#ffffff', // Shopping - orange
    };
